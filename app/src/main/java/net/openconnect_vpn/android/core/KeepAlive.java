...
public class KeepAlive extends BroadcastReceiver {
	...
	public static final String ACTION_KEEPALIVE_ALARM = "net.openconnect_vpn.android.KEEPALIVE_ALARM";
	...
	private void scheduleNext(Context context, int delayMs) {
		Intent intent = new Intent("net.openconnect_vpn.android.KEEPALIVE_ALARM");
	...
	public void start(Context context) {
		...
		mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "OpenConnect: KeepAlive");
