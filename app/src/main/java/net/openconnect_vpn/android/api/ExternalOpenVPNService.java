...
import net.openconnect_vpn.android.core.OpenVPN.ConnectionStatus;
...
public class ExternalOpenVPNService extends Service {
	...
	private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
		...
		public void startProfile(String profileUUID) throws RemoteException {
			...
			shortVPNIntent.setClass(getBaseContext(),net.openconnect_vpn.android.LaunchVPN.class);
			shortVPNIntent.putExtra(net.openconnect_vpn.android.LaunchVPN.EXTRA_KEY,profileUUID);
