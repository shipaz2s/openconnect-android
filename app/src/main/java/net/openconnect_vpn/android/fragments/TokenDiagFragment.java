...
public class TokenDiagFragment extends Fragment {
	...
	public static final String EXTRA_PIN = "net.openconnect_vpn.android.PIN";
	public static final String EXTRA_PIN_PROMPTED = "net.openconnect_vpn.android.PIN_PROMPTED";
